...
<link rel="stylesheet" href="${ctx }/resources/css/style.css" type="text/css"
	media="screen">
<link rel="stylesheet" href="${ctx }/resources/css/grid.css" type="text/css"
	media="screen">
<script src="${ctx }/resources/js/jquery-1.6.2.min.js" type="text/javascript"></script>
<script src="${ctx }/resources/js/jquery.galleriffic.js" type="text/javascript"></script>
<script src="${ctx }/resources/js/jquery.opacityrollover.js" type="text/javascript"></script>
<!--[if lt IE 7]>
					...
					<div class="grid_12">
						<nav>
							<ul class="menu">
								...
								<li><a href="${ctx }/resources/services.html">Services</a></li>
								<li><a href="${ctx }/resources/catalogue.html">Catalogue</a></li>
								<li><a href="${ctx }/resources/pricing.html">Pricing</a></li>
								<li><a href="${ctx }/resources/contacts.html">Contacts</a></li>
							</ul>
						</nav>
					</div>
				</div>
		...
		<div class="row-2">
			<div class="main">
				<div class="container_12">
					<div class="grid_9">
						<h1>
							<a class="logo" href="home">Int<strong>e</strong>rior
							</a> <span>Design</span>
						</h1>
					</div>
					<div class="grid_3">
								...
								<div class="wrapper indent-bot">
									...
									<div id="thumbs" class="navigation">
										<ul class="thumbs noscript">
											<li><a class="thumb" href="${ctx }/resources/images/gallery-img1.jpg"
												title=""> <img src="${ctx }/resources/images/thumb-1.jpg" alt="" /><span></span>
											</a></li>
											<li><a class="thumb" href="${ctx }/resources/images/gallery-img2.jpg"
												title=""> <img src="${ctx }/resources/images/thumb-2.jpg" alt="" /> <span></span></a>
											</li>
											<li><a class="thumb" href="${ctx }/resources/images/gallery-img3.jpg"
												title=""> <img src="${ctx }/resources/images/thumb-3.jpg" alt="" /> <span></span></a>
											</li>
											<li><a class="thumb" href="${ctx }/resources/images/gallery-img4.jpg"
												title=""> <img src="${ctx }/resources/images/thumb-4.jpg" alt="" /> <span></span></a>
											</li>
											<li><a class="thumb" href="${ctx }/resources/images/gallery-img5.jpg"
												title=""> <img src="${ctx }/resources/images/thumb-5.jpg" alt="" /> <span></span></a>
											</li>
											<li><a class="thumb" href="${ctx }/resources/images/gallery-img6.jpg"
												title=""> <img src="${ctx }/resources/images/thumb-6.jpg" alt="" /> <span></span></a>
											</li>
										</ul>
									</div>
								</div>
								<div class="inner">
									<div class="wrapper">
										...
										<div class="extra-wrap indent-top2">
											...
											pages: <a class="color-3" href="home">About</a>, <a
												class="color-3" href="${ctx }/resources/services.html">Services</a>, <a
												class="color-3" href="${ctx }/resources/catalogue.html">Catalogue</a>, <a
												class="color-3" href="${ctx }/resources/pricing.html">Pricing</a>, <a
												class="color-3" href="${ctx }/resources/contacts.html">Contact Us</a> (note
											that contact us form – doesn’t work).
										</div>
									</div>
								</div>
							</div>
									...
									<article class="grid_12">
										...
										<div class="wrapper">
											<article class="grid_6 alpha">
												<figure class="${ctx }/resources/img-indent frame">
													<img src="${ctx }/resources/images/page1-img1.jpg" alt="" />
												</figure>
